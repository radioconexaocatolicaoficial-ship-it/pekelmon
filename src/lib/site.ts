...
/** JPEG 1200×630 do banner da chapa. Nome novo para o WhatsApp não reusar o cache. */
export const OG_IMAGE_PATH = "/og-banner-kelmon-chapa-1200.jpg";
...
export const PAGE_SEO = {
  ...
  links: {
    ...
    image: "/og-banner-kelmon-chapa-1200.jpg",
    imageWidth: "1200",
    imageHeight: "630",
  },
} as const;
