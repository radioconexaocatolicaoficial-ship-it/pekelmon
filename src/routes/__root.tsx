...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Padre Kelmon — Deputado Federal por São Paulo" },
      {
        name: "description",
        content:
          "Padre Kelmon, pré-candidato a Deputado Federal por São Paulo pelo PL. Fé, família e coragem para resgatar o Brasil.",
      },
